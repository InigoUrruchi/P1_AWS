...
class meshtastic():
    def __init__(self):
        ...
        self.key = "ymACgCy9Tdb8jHbLxUxZ/4ADX+BWLOGVihmKHcHTVyp="
        self.message_text = "Soy Inigo"
        ...
        self.node_name = '!b12d45c8' # random_hex_chars
        self.node_number = int(self.node_name.replace("!", ""), 16)
        self.global_message_id = random.getrandbits(32)
        self.client_short_name = "INI"
        self.client_long_name = "Inigo"
        self.lat = "0"
        self.lon = "0"
        self.alt = "0"
        ...
        self.logger = Logger("meshtastic")
    # Program Base Functions
    def set_topic(self):
        if self.debug: print("set_topic")
        self.node_name = '!' + hex(self.node_number)[2:]
    ...
    def on_disconnect(self, userdata, flags, reason_code, properties):
